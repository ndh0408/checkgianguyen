...
{
    /// <inheritdoc />
    public partial class CreateCleanDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CheckInEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BannerImageUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    OrganizerEmail = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    MaxGuests = table.Column<int>(type: "int", nullable: true),
                    MaxAttendees = table.Column<int>(type: "int", nullable: false),
                    IsPublic = table.Column<bool>(type: "bit", nullable: false),
                    AllowMultipleCheckIn = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_TenantId_StartTime",
                table: "Events",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invitations_Code_IsUsed",
                table: "Invitations",
